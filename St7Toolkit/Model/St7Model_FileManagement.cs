...
namespace St7Toolkit
{
    ...
    {      
        ...
        public bool OpenFile()
        {
            ...
            if (this.FileDirectory == string.Empty) { return false; }
            // Try openning Strand7 model file
            return (FileIO.OpenFile(this.UId, this.FileDirectory, FileIO.ScratchPath));
        }
        ...
        public bool ReadFile()
        {
            ...
            if (!this.PullNodeFromSt7Doc()) { return false; }
